...
| Skill | When to use |
|---|---|
| [read/navigate-app](../read/navigate-app/SKILL.md) | First contact with the app, "what pages exist?", finding files. |
| [read/investigate-component](../read/investigate-component/SKILL.md) | A symptom → which construct is responsible. |
| [read/inspect-construct-schema](../read/inspect-construct-schema/SKILL.md) | About to hand-edit; need to know which property names are idiomatic. |
| [edit/create-page](../edit/create-page/SKILL.md) | Adding a new page. |
| [edit/add-region-or-item-to-page](../edit/add-region-or-item-to-page/SKILL.md) | Adding regions, items, buttons, processes, branches to an existing page. |
| [edit/edit-shared-component](../edit/edit-shared-component/SKILL.md) | LOVs, lists, breadcrumbs, authorizations, app-items, page-groups. |
| [edit/delete-component](../edit/delete-component/SKILL.md) | Removing any existing construct (region, item, button, process, page, …). |
| [verify/validate-after-edit](../verify/validate-after-edit/SKILL.md) | After every editing pass. **Mandatory before you declare done.** |
...
Non-zero exit = not done. Fix what it reports, then re-run. See [verify/validate-after-edit](../verify/validate-after-edit/SKILL.md) for how to interpret each issue kind, and for the authoritative `--official` SQLcl check when it's available.
